...
#    parser_easyphylo.add_argument('-m', '--mafft', required=False, default ="--auto", help='MAFFT: Mafft alignment options. Default  --auto')
    ...
    parser_blastology.add_argument('--mafft', required=False, default ="--auto", help='MAFFT: alignment options. Accepts raw MAFFT CLI options, or aliases auto, fast, linsi. Default: --auto')
